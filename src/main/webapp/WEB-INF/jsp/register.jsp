...
<div class="form-container">
    ...
    <form:form method="post" modelAttribute="user" action="register">
        ...
        <div class="form-group">
            ...
            <form:input name="confirmPassword" value="${user.confirmPassword}" type="password" class="form-control" id="exampleInputConfirmPassword1" placeholder="Password" path="confirmPassword"/>
